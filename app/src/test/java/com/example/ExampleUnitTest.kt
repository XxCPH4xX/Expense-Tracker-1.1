...
class ExampleUnitTest {
  ...
  fun testAutoBackupAndRestoreLifecycle() {
    ...
    com.example.data.export.SnapshotManager.saveAutoBackup(context, categories, transactions)
    val backupContent = com.example.data.export.SnapshotManager.getLatestAutoBackupContent(context)
